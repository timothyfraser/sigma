...
# Let's view it. (see console below)
                             ...
                             Each row is a country-year, marking the life expectancy, population, and gross domestic product (GDP) per capita.
...
Huh. How odd. 
Looks like the `cut` of diamonds has very little impact on what `price` they are sold at! 
