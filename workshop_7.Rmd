...
```{r setup_workshop_7, include = FALSE}
nm = loadedNamespaces()
if("mosaicCalc" %in% nm){ detach(name = "package:mosaicCalc", unload = TRUE) }
if("mosaic" %in% nm){ detach(name = "package:mosaic", unload = TRUE) }
...
```{r gif, echo = FALSE, out.width="100%", fig.cap="Crash Testing with LEGOs: a very safe prototype"}
knitr::include_graphics("https://c.tenor.com/5duS2KkYJGAAAAAC/lego-car.gif")
```
...
## LC1 {.tabset .tabset-pills .unnumbered}
...
## LC2 {.tabset .tabset-pills .unnumbered}
...
It works! The characteristic life for `tf = 28` is ~`r c_hat(tf = 28) %>% round(0)`.
...
```{r gif2, echo = FALSE, out.width="100%", fig.cap="Wasn't that fun?"}
knitr::include_graphics("https://media4.giphy.com/media/9ADoZQgs0tyww/giphy.gif")
```
