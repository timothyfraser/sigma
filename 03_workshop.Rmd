...
# To Calculate the probability that a customer chooses the target genre given a ticket purchase
...
cat("Probability that a customer chooses a", target_genre, "movie given a ticket purchase:", probability_target_genre_given_purchase, "\n")
