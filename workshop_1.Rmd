...
```{r img-1_0, echo = FALSE, out.width = "100%", fig.align='center', fig.cap= "Visual Intro to Using RStudio.Cloud"}
knitr::include_graphics(i[["img_1_0"]]$file)
```
...
knitr::include_graphics(i[["img_1_1"]]$file)
knitr::include_graphics(i[["img_1_2"]]$file)
```
