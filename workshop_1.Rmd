...
source("f/images.R") # Get images function
...
```{r, echo = FALSE, out.width = "100%", fig.align='center', fig.cap= "Visual Intro to Using RStudio.Cloud"}
knitr::include_graphics(path = i$img_1_0$file)
```
...
```{r, echo = FALSE, out.width = "49%", fig.align = 'center', fig.cap="Open New Script"}
knitr::include_graphics(path = i$img_1_1$file)
```
```{r, echo = FALSE, out.width = "49%", fig.align='center', fig.cap="Save New Script!"}
knitr::include_graphics(path = i$img_1_2$file)
```
...
knitr::include_graphics(i[["img_1_4"]]$file)
```
