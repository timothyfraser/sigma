# Workshop: Coding in R {#workshop_1}
...
```{r graphic_1, echo = FALSE, out.width = "100%", fig.align='center', fig.cap= "Visual Intro to Using RStudio.Cloud"}
...
```{r, echo = FALSE, out.width = "100%", fig.cap = "Descriptive Stats function Cheatsheet!"}
