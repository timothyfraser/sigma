...
m3 = lm(formula = 'yum ~ molasses * ginger + molasses_sq + ginger_sq', data = cookies)
```
...
Let's make a more complex 'Second-Order' polynomial model: `yum ~ molasses * ginger + molasses_sq + ginger_sq` (which we did as `m3`)
```{python}
print(m3.params)
```
...
# Add squared terms for prediction
myx_demo['molasses_sq'] = myx_demo['molasses'] ** 2
myx_demo['ginger_sq'] = myx_demo['ginger'] ** 2

# Make predictions
mypred_demo = myx_demo.copy()
mypred_demo['yhat'] = m3.predict(mypred_demo)

# Create the contour-like plot using geom_tile()
g = (ggplot(mypred_demo, aes(x='molasses', y='ginger', fill='yhat')) +
          geom_tile() +
          scale_fill_cmap(cmap_name='plasma', name='Predicted\nYum\nFactor'))

# Save and display
g.save(filename = "plotnine_figures/15_contour_demo.png", dpi=200, width=8, height=6)
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("plotnine_figures/15_contour_demo.png")
```
...
*Note*: You have to pick these values!! (eg. 0 to 5, 0 to 3, etc.) We want to make predictions slightly *beyond* our observed data. Just remember, a grid of 20 by 20 items produces 400 cells; 100 by 100 produces 10,000 cells; etc. Once you get above a few 1000, `plotnine` may start to slow down quickly.
...
```{python, include=FALSE}
# Save the plot
g.save(filename = "plotnine_figures/15_contour_tile1.png", dpi=200, width=8, height=6)
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("plotnine_figures/15_contour_tile1.png")
```
...
###  Pretty contour plots with `matplotlib`!
...
```{python, include=FALSE}
# Save the plot
g_onestep.save(filename = "plotnine_figures/15_contour_onestep.png", dpi=200, width=8, height=6)
```

```{r, echo=FALSE, out.width="100%", fig.cap="One-step RSM contour plot"}
knitr::include_graphics("plotnine_figures/15_contour_onestep.png")
```
...
```{python, include=FALSE}
# Save the plot
g3.save(filename = "plotnine_figures/15_plot_2.png", dpi=200, width=8, height=5)
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("plotnine_figures/15_plot_2.png")
```
...
```{python, include=FALSE}
# Save the plot
g_lc.save(filename = "plotnine_figures/15_learning_check_2.png", dpi=200, width=8, height=6)
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("plotnine_figures/15_learning_check_2.png")
```
...
Next, let's use our grid to visualize the contours in `plotnine`!
...
```{python, include=FALSE}
# Save the plot
g5.save(filename = "plotnine_figures/15_plot.png", dpi=500, width=10, height=4)
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("plotnine_figures/15_plot.png")
```
...
```{python, include=FALSE}
# Save the plot
g_lc3.save(filename = "plotnine_figures/15_learning_check_3.png", dpi=200, width=10, height=4)
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("plotnine_figures/15_learning_check_3.png")
```
...
```{python, include=FALSE}
# Save the plot
g_study_range.save(filename = "plotnine_figures/15_study_range.png", dpi=200, width=10, height=4)
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("plotnine_figures/15_study_range.png")
```
