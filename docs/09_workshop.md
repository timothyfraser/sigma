...
<img src="09_workshop_files/figure-html/unnamed-chunk-11-1.png" width="672" />
<br>
<br>
...
## -0.009971  0.028641  0.085338  0.152521  0.178840  1.078695
```
...
ftop = function(prob_a, prob_b, prob_c){

  # Try to lightly adapt what you below into something that...
  # doesn't use any if-then statements
...
## Learning Check 2: Applying Exponential Distributions

What if each of these events had an exponential lifespan distribution? Could we see how the probability of the top event changes over time `t`, given a set of failure rates `lambda_a`, `lambda_b`, `lambda_c`, etc.?
