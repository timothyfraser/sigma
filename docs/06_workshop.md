...
## $ id     <dbl> 141, 41, 139, 31, 44, 150, 109, 91, 145, 29, 142, 136, 11, 75, …
## $ time   <dbl> 15, 5, 13, 3, 5, 15, 11, 9, 15, 3, 15, 13, 1, 7, 1, 5, 9, 3, 15…
## $ temp   <dbl> 45.9, 46.6, 46.3, 45.8, 46.7, 41.5, 45.9, 44.0, 42.7, 43.3, 44.…
## $ ph     <dbl> 4.6, 5.8, 5.1, 6.3, 5.6, 4.6, 4.2, 5.4, 6.2, 5.0, 5.6, 5.1, 5.8…
## $ sulfur <dbl> 0.4, 0.2, 0.2, 0.0, 0.4, 1.2, 0.4, 0.3, 0.4, 0.3, 0.6, 1.0, 0.7…
```
