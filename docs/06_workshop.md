...
## $ id     <dbl> 14, 152, 51, 147, 43, 94, 157, 88, 39, 110, 98, 149, 91, 74, 63…
## $ time   <dbl> 1, 15, 5, 15, 5, 9, 15, 9, 3, 11, 9, 15, 9, 7, 7, 3, 5, 1, 7, 1…
## $ temp   <dbl> 46.1, 44.0, 42.9, 47.4, 44.6, 46.1, 43.4, 46.5, 46.8, 45.5, 44.…
## $ ph     <dbl> 5.1, 5.0, 5.1, 5.6, 5.3, 5.5, 5.3, 4.9, 5.7, 5.6, 4.4, 5.3, 5.4…
## $ sulfur <dbl> 0.0, 0.5, 0.3, 0.9, 0.0, 0.3, 0.8, 0.4, 0.3, 4.0, 0.5, 3.6, 0.3…
```
