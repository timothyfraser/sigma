...
## $ id     <dbl> 22, 160, 78, 128, 97, 147, 21, 9, 63, 86, 138, 47, 46, 144, 101…
## $ time   <dbl> 3, 15, 7, 13, 9, 15, 3, 1, 7, 9, 13, 5, 5, 15, 11, 7, 7, 7, 15,…
## $ temp   <dbl> 45.6, 44.3, 46.4, 42.4, 44.4, 47.4, 46.0, 42.2, 47.2, 49.4, 42.…
## $ ph     <dbl> 6.2, 5.4, 5.6, 4.6, 5.9, 5.6, 6.3, 5.2, 6.5, 5.6, 5.7, 6.1, 5.7…
## $ sulfur <dbl> 0.2, 2.0, 1.7, -0.1, 0.3, 0.9, 0.0, 0.0, 0.1, 0.3, 1.2, 0.4, 0.…
```
