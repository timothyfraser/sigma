...
## $ id     <dbl> 49, 25, 114, 9, 29, 22, 32, 78, 159, 35, 12, 38, 32, 159, 39, 1…
## $ time   <dbl> 5, 3, 11, 1, 3, 3, 3, 7, 15, 3, 1, 3, 3, 15, 3, 15, 7, 9, 9, 11…
## $ temp   <dbl> 46.6, 47.9, 44.1, 42.2, 43.3, 45.6, 44.1, 46.4, 45.1, 44.8, 44.…
## $ ph     <dbl> 5.8, 5.4, 4.6, 5.2, 5.0, 6.2, 5.2, 5.6, 5.6, 6.0, 5.3, 6.3, 5.2…
## $ sulfur <dbl> 0.0, 0.7, 0.2, 0.0, 0.3, 0.2, 0.4, 1.7, 0.5, 0.4, 1.1, 0.4, 0.4…
```
