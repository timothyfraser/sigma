...
## $ id     <dbl> 130, 34, 57, 20, 109, 82, 60, 98, 137, 128, 80, 21, 22, 31, 58,…
## $ time   <dbl> 13, 3, 5, 1, 11, 9, 5, 9, 13, 13, 7, 3, 3, 3, 5, 11, 13, 15, 1,…
## $ temp   <dbl> 43.1, 44.4, 47.0, 45.7, 45.9, 44.8, 44.1, 44.7, 44.1, 42.4, 45.…
## $ ph     <dbl> 5.8, 4.3, 5.4, 6.4, 4.2, 6.0, 4.9, 4.4, 6.5, 4.6, 5.1, 6.3, 6.2…
## $ sulfur <dbl> 1.0, 0.0, 0.2, 0.9, 0.4, 0.1, 0.4, 0.5, 0.1, -0.1, 0.0, 0.0, 0.…
```
