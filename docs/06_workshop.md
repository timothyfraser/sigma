...
## $ id     <dbl> 99, 9, 109, 71, 57, 81, 111, 73, 17, 52, 66, 133, 140, 109, 87,…
## $ time   <dbl> 9, 1, 11, 7, 5, 9, 11, 7, 1, 5, 7, 13, 13, 11, 9, 7, 15, 1, 15,…
## $ temp   <dbl> 41.5, 42.2, 45.9, 43.8, 47.0, 44.4, 43.7, 40.7, 42.8, 45.1, 43.…
## $ ph     <dbl> 5.3, 5.2, 4.2, 5.9, 5.4, 5.6, 6.1, 5.1, 6.2, 5.4, 5.6, 5.1, 5.0…
## $ sulfur <dbl> 0.0, 0.0, 0.4, 0.0, 0.2, 2.7, 0.4, 0.2, 0.0, 0.0, 1.3, 0.8, 0.5…
```
