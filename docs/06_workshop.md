...
## $ id     <dbl> 79, 104, 65, 86, 101, 34, 142, 5, 160, 98, 60, 96, 95, 140, 143…
## $ time   <dbl> 7, 11, 7, 9, 11, 3, 15, 1, 15, 9, 5, 9, 9, 13, 15, 11, 13, 13, …
## $ temp   <dbl> 44.0, 43.1, 47.8, 49.4, 46.8, 44.4, 44.6, 45.9, 44.3, 44.7, 44.…
## $ ph     <dbl> 6.5, 5.8, 5.8, 5.6, 4.8, 4.3, 5.6, 5.1, 5.4, 4.4, 4.9, 6.1, 5.7…
## $ sulfur <dbl> 0.2, 0.9, 0.4, 0.3, 0.4, 0.0, 0.6, 0.0, 2.0, 0.5, 0.4, 0.1, 0.0…
```
