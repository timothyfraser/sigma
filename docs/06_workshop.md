...
## $ id     <dbl> 68, 112, 85, 45, 83, 126, 123, 123, 55, 50, 84, 119, 107, 88, 3…
## $ time   <dbl> 7, 11, 9, 5, 9, 13, 13, 13, 5, 5, 9, 11, 11, 9, 3, 11, 1, 3, 13…
## $ temp   <dbl> 44.1, 48.1, 41.2, 44.4, 45.7, 43.9, 43.0, 43.0, 46.1, 47.7, 47.…
## $ ph     <dbl> 6.8, 6.3, 5.1, 5.5, 4.4, 4.9, 5.3, 5.3, 5.3, 4.9, 5.6, 4.8, 5.7…
## $ sulfur <dbl> 0.1, 0.9, 0.3, 0.0, 0.0, 1.9, 0.7, 0.7, 1.6, 0.1, 0.5, -0.1, 1.…
```
