...
## $ id     <dbl> 37, 116, 136, 13, 83, 66, 66, 83, 50, 40, 23, 79, 145, 71, 96, …
## $ time   <dbl> 3, 11, 13, 1, 9, 7, 7, 9, 5, 3, 3, 7, 15, 7, 9, 5, 13, 5, 13, 1…
## $ temp   <dbl> 46.6, 44.6, 44.7, 44.9, 45.7, 43.9, 43.9, 45.7, 47.7, 47.9, 44.…
## $ ph     <dbl> 5.1, 5.3, 5.1, 5.9, 4.4, 5.6, 5.6, 4.4, 4.9, 5.4, 5.3, 6.5, 6.2…
## $ sulfur <dbl> 0.1, 1.0, 1.0, 0.1, 0.0, 1.3, 1.3, 0.0, 0.1, 0.0, 0.0, 0.2, 0.4…
```
