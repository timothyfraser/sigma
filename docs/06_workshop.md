...
## $ id     <dbl> 64, 98, 7, 30, 35, 119, 114, 106, 63, 108, 139, 48, 70, 64, 82,…
## $ time   <dbl> 7, 9, 1, 3, 3, 11, 11, 11, 7, 11, 13, 5, 7, 7, 9, 13, 13, 1, 15…
## $ temp   <dbl> 40.9, 44.7, 42.3, 46.7, 44.8, 41.1, 44.1, 48.4, 47.2, 45.9, 46.…
## $ ph     <dbl> 5.5, 4.4, 5.5, 5.3, 6.0, 4.8, 4.6, 5.3, 6.5, 5.7, 5.1, 5.7, 4.8…
## $ sulfur <dbl> 0.4, 0.5, 0.0, 1.0, 0.4, -0.1, 0.2, 0.2, 0.1, 0.6, 0.2, 0.1, 0.…
```
