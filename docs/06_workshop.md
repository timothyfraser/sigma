...
## $ id     <dbl> 54, 139, 21, 25, 115, 51, 92, 38, 31, 121, 148, 39, 131, 136, 3…
## $ time   <dbl> 5, 13, 3, 3, 11, 5, 9, 3, 3, 13, 15, 3, 13, 13, 3, 9, 9, 13, 7,…
## $ temp   <dbl> 43.1, 46.3, 46.0, 47.9, 46.2, 42.9, 45.0, 43.7, 45.8, 43.7, 47.…
## $ ph     <dbl> 5.7, 5.1, 6.3, 5.4, 5.7, 5.1, 5.3, 6.3, 6.3, 5.9, 5.3, 5.7, 6.0…
## $ sulfur <dbl> 1.0, 0.2, 0.0, 0.7, 0.8, 0.3, 0.4, 0.4, 0.0, 0.1, 0.6, 0.3, -0.…
```
