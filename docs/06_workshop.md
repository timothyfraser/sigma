...
## $ id     <dbl> 81, 42, 52, 40, 91, 145, 89, 118, 97, 123, 78, 91, 68, 96, 84, …
## $ time   <dbl> 9, 5, 5, 3, 9, 15, 9, 11, 9, 13, 7, 9, 7, 9, 9, 13, 1, 15, 15, …
## $ temp   <dbl> 44.4, 44.3, 45.1, 47.9, 44.0, 42.7, 44.2, 44.4, 44.4, 43.0, 46.…
## $ ph     <dbl> 5.6, 6.3, 5.4, 5.4, 5.4, 6.2, 5.5, 5.0, 5.9, 5.3, 5.6, 5.4, 6.8…
## $ sulfur <dbl> 2.7, 1.4, 0.0, 0.0, 0.3, 0.4, 0.0, 0.9, 0.3, 0.7, 1.7, 0.3, 0.1…
```
