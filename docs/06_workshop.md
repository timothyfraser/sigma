...
## $ id     <dbl> 84, 25, 120, 128, 98, 74, 107, 136, 74, 46, 156, 33, 136, 85, 5…
## $ time   <dbl> 9, 3, 11, 13, 9, 7, 11, 13, 7, 5, 15, 3, 13, 9, 5, 7, 13, 9, 7,…
## $ temp   <dbl> 47.3, 47.9, 45.2, 42.4, 44.7, 45.5, 45.7, 44.7, 45.5, 42.5, 45.…
## $ ph     <dbl> 5.6, 5.4, 5.3, 4.6, 4.4, 5.2, 5.7, 5.1, 5.2, 5.7, 4.2, 4.9, 5.1…
## $ sulfur <dbl> 0.5, 0.7, 1.8, -0.1, 0.5, 0.4, 1.6, 1.0, 0.4, 0.5, 1.4, 0.0, 1.…
```
