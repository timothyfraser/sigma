...
## $ id     <dbl> 55, 127, 47, 23, 151, 30, 50, 92, 38, 111, 55, 48, 86, 133, 102…
## $ time   <dbl> 5, 13, 5, 3, 15, 3, 5, 9, 3, 11, 5, 5, 9, 13, 11, 15, 9, 7, 7, …
## $ temp   <dbl> 46.1, 41.6, 44.0, 44.0, 46.4, 46.7, 47.7, 45.0, 43.7, 43.7, 46.…
## $ ph     <dbl> 5.3, 5.2, 6.1, 5.3, 5.3, 5.3, 4.9, 5.3, 6.3, 6.1, 5.3, 5.7, 5.6…
## $ sulfur <dbl> 1.6, 1.1, 0.4, 0.0, 0.2, 1.0, 0.1, 0.4, 0.4, 0.4, 1.6, 0.1, 0.3…
```
