...
## $ id     <dbl> 77, 134, 159, 79, 26, 15, 92, 93, 31, 109, 88, 1, 49, 85, 140, …
## $ time   <dbl> 7, 13, 15, 7, 3, 1, 9, 9, 3, 11, 9, 1, 5, 9, 13, 3, 5, 13, 15, …
## $ temp   <dbl> 44.9, 41.5, 45.1, 44.0, 50.3, 46.0, 45.0, 51.1, 45.8, 45.9, 46.…
## $ ph     <dbl> 5.1, 4.7, 5.6, 6.5, 5.8, 5.3, 5.3, 4.8, 6.3, 4.2, 4.9, 5.1, 5.8…
## $ sulfur <dbl> 0.1, 0.8, 0.5, 0.2, 0.8, 0.2, 0.4, 0.0, 0.0, 0.4, 0.4, 0.0, 0.0…
```
