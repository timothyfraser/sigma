...
## $ id     <dbl> 73, 56, 136, 21, 15, 115, 45, 73, 150, 91, 132, 36, 87, 3, 49, …
## $ time   <dbl> 7, 5, 13, 3, 1, 11, 5, 7, 15, 9, 13, 3, 9, 1, 5, 7, 3, 5, 9, 9,…
## $ temp   <dbl> 40.7, 44.1, 44.7, 46.0, 46.0, 46.2, 44.4, 40.7, 41.5, 44.0, 46.…
## $ ph     <dbl> 5.1, 5.0, 5.1, 6.3, 5.3, 5.7, 5.5, 5.1, 4.6, 5.4, 5.9, 5.2, 5.6…
## $ sulfur <dbl> 0.2, 0.4, 1.0, 0.0, 0.2, 0.8, 0.0, 0.2, 1.2, 0.3, 2.7, 0.2, 0.0…
```
