...
## $ id     <dbl> 150, 22, 13, 35, 12, 85, 155, 62, 113, 75, 99, 93, 61, 48, 34, …
## $ time   <dbl> 15, 3, 1, 3, 1, 9, 15, 7, 11, 7, 9, 9, 7, 5, 3, 5, 7, 1, 13, 3,…
## $ temp   <dbl> 41.5, 45.6, 44.9, 44.8, 44.2, 41.2, 45.0, 43.7, 49.1, 49.0, 41.…
## $ ph     <dbl> 4.6, 6.2, 5.9, 6.0, 5.3, 5.1, 4.7, 5.1, 5.5, 5.5, 5.3, 4.8, 5.5…
## $ sulfur <dbl> 1.2, 0.2, 0.1, 0.4, 1.1, 0.3, 1.0, 0.0, 0.1, 0.5, 0.0, 0.0, 0.7…
```
