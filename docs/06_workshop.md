...
## $ id     <dbl> 55, 43, 156, 70, 104, 63, 1, 102, 90, 160, 156, 83, 8, 99, 41, …
## $ time   <dbl> 5, 5, 15, 7, 11, 7, 1, 11, 9, 15, 15, 9, 1, 9, 5, 13, 1, 15, 3,…
## $ temp   <dbl> 46.1, 44.6, 45.6, 43.6, 43.1, 47.2, 43.2, 45.1, 44.7, 44.3, 45.…
## $ ph     <dbl> 5.3, 5.3, 4.2, 4.8, 5.8, 6.5, 5.1, 4.4, 6.1, 5.4, 4.2, 4.4, 5.3…
## $ sulfur <dbl> 1.6, 0.0, 1.4, 0.1, 0.9, 0.1, 0.0, 0.0, 0.0, 2.0, 1.4, 0.0, 0.0…
```
