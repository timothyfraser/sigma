...
```{python install-packages, eval=FALSE}
...
```{python define-describe-function}
...
```{r display-05-process-overview, out.width="100%", echo=FALSE}
knitr::include_graphics("images/05_process_overview.png")
```

```{python process-histogram}
...
```{r display-05-process-histogram, out.width="100%", echo=FALSE}
knitr::include_graphics("images/05_process_histogram.png")
```
...
```{python calculate-subgroup-stats}
...
knitr::include_graphics("images/05_control_chart.png")
```
...
```{python learning-check-ph-chart}
...
```{r, out.width="100%", echo=FALSE}
knitr::include_graphics("images/05_ph_chart.png")
```
...
```{r, out.width="100%", echo=FALSE}
knitr::include_graphics("images/05_moving_range_chart.png")
```
